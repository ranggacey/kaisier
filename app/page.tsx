...
export default function KaisierApp() {
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-slate-50 flex flex-col font-sans pb-28 shadow-2xl antialiased selection:bg-[#4A6278] selection:text-[#E5D3B3]">
